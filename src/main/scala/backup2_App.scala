  ...
  private def scrape(driver: HtmlUnitDriver): Unit = {
    ...
    driver.findElementByXPath("//div[@id='js-bukkenList']")
      ...
      */
      ...
      //val headerElem = we.findElement(By.xpath("//div[@class='property-header-cbx']"))
      //val propertyElem = we.findElement(By.xpath("//div[@class='property-body']"))

      //getRoomTitle(headerElem)
    }
  }
